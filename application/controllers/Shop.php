...
class Shop extends MY_Controller
{
    ...
    public function search($page = null)
    {
        ...
        $data['content']        = $this->shop->select(
            ['product.id', 'product.title AS product_title', 'product.image', 'product.price', 'product.is_available', 'category.title AS category_title', 'product.description', 'category.slug AS category_slug']
